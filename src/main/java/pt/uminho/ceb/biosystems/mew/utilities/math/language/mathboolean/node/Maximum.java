...
public class Maximum extends AbstractSyntaxTreeNode<DataTypeEnum, IValue> {

	private static final long serialVersionUID = 5813011834793145070L;

	public Maximum(AbstractSyntaxTreeNode<DataTypeEnum, IValue> left, AbstractSyntaxTreeNode<DataTypeEnum, IValue> right) {
	...
	public String toString() {
		...
		return "max(" + leftTermString + ";" + rightTermString + ")";
	}
