...
public class Multiplication  extends AbstractSyntaxTreeNode<DataTypeEnum,IValue> {
    ...
    public Multiplication(AbstractSyntaxTreeNode<DataTypeEnum,IValue> leftTerm,AbstractSyntaxTreeNode<DataTypeEnum,IValue> rightTerm){
        super(DataTypeEnum.DOUBLE);
        childNodeArray = new AbstractSyntaxTreeNode[2];
