...
public class Intersection extends AbstractSyntaxTreeNode<DataTypeEnum,IValue> {
    ...
    public IValue evaluate(IEnvironment<IValue> environment) {
        ...
        return new OtherValue<Collection>(CollectionUtils.getIntersectionValues((Collection)leftTermResultValue.getValue(), (Collection)rightTermResultValue.getValue()));
    }
