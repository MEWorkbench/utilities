package pt.uminho.ceb.biosystems.mew.utilities.datastructures.tree.trie;
...
//	public final static char DELIMITER = '\u0001';
	 ...
	 */
	private boolean remove(Node root, String word, int offset, Node branch,
			Node branchLast, Node branchNext) {
		if (offset == word.length()) {
	 ...
	 * offset...
	 */
	private int longestMatch(Node root, String word, int offset, int depth,
			int maxFound) {
	...
	private static void writeNode(Node root, java.io.BufferedWriter out,
			char[] chars, int pointer, String pre, String post)
	...
	/*
	 * public static void main(String[] args) { Trie t = new Trie();
	 * System.out.println(t.remove("test"));
	 * System.out.println(t.isEntry("isEntry")); t.getAll();
	 * System.out.println(t.size()); System.out.println(t.suggest("b").length);
	 * t.add("ra"); t.add("aw"); System.out.println(t.censor("rawr"));
	 * t.add("rawr"); System.out.println(t.censor("rawr")); }//
	 */
